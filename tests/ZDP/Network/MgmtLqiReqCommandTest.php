...
/**
 * Class MgmtLqiReqCommandTest
 *
 * @package Munisense\Zigbee\ZDP\Network
 */
class MgmtLqiReqCommandTest extends \PHPUnit_Framework_TestCase
  {
  public function testInclusionByConstructor()
    {
    $base_frame = MgmtLqiReqCommand::construct(0xa1);
    $transaction_id = chr(0x12);
    $parent = new ZDPFrame($transaction_id .$base_frame->getFrame(), $base_frame->getClusterId());
    $this->assertInstanceOf("Munisense\\Zigbee\\ZDP\\Network\\MgmtLqiReqCommand", $parent->getPayloadObject());
