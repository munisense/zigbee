 ...
 */
class NwkAddrRspCommand extends AbstractFrame implements IZDOCommandFrame
  {
  const CLUSTER_ID = 0x8000;
  ...
  public function setFrame($frame)
    ...
    $this->setNwkAddrRemoteDev(Buffer::unpackInt8u($frame));
  ...
  public function getFrame()
    ...
    Buffer::packInt8u($frame, $this->getNwkAddrRemoteDev());
